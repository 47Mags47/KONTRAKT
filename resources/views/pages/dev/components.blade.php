...
@section('content')
        ...
        <x-comment.box>
            ...
            <ul class="comment-list">
                <li>
                    ...
                    <p class="comment">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia ullam repudiandae
                        corrupti eaque alias hic eligendi excepturi iusto officia, magni distinctio, unde quo, error dolores
    ...
    <section class="form-element">
        <x-form.default header="Стандартная форма">
            ...
            <x-input.adder          label="Список элементов с возможностью добавления"
                name="" />
            <x-input.adder-show     label="Список элементов с возможностью добавления (представление)"
                :items="['Запись 1', 'Запись 2']" />
            <x-input.select         label="Выбор из списка"
                name=""></x-input.select>
            <x-input.text           label="Тектовое поле"
                name=""/>
            <x-input.text-show      label="Тектовое поле (представление)"
                value="Значение поля"/>
            <x-input.textarea       label="Тектовое поле"
                name=""/>
            <x-input.textarea-show  label="Тектовое поле (представление)"
                value="Значение поля"/>
        </x-form.default>
    </section>
    ...
    <p class="box-header">Дополнительные компоненты форм</p>
